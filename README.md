...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/extract_model-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13093&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/extract_model-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `extract_model` can be installed with:

```
conda install extract_model
```

It is possible to list all of the versions of `extract_model` available on your platform with:
